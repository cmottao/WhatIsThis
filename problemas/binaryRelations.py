from utils import multiplicar_relaciones

'''
    60. Union: Calculate and print the relation union.
'''

def relationUnion(a, b):
    n = len(a)
    m = len(a[0])
    c = []
    for i in range(n):
...
'''
    61. Intersection: Calculate and print the intersection relation.
'''

def relationIntersection(a, b):
    n = len(a)
    m = len(a[0])
    c = []
    for i in range(n):
...
'''
    62. Symmetry: Determines if the first relation is symmetric or not.
'''
...
'''
    63. Reflexivity: Determines if the first relation is reflexive or not.
'''
...
'''
    64. Transitivity: Determines if the first relation read is transitive or not.
'''
